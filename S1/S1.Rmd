---
title: "**Práctica de Laboratorio 1. Lectura de datos (I)**"
...
Las sesiones se realizarán durante 2 horas, teniendo a la mitad del curso un receso de 10 minutos. El material de la sesión estará disponible todos los jueves, previo a cada clase. Se requiere puntualidad del alumno/a, así como respeto y responsabilidad en las actividades.

### **Calificación**

Trabajo final: tres entregables

1. Primer entregable: 15/09
2. Segundo entregable: 06/10
3. Tercer entrebable: 17/11
...
### **3.2. Configuración de directorio de trabajo**
...
### **3.4. R Markdown y Knit en R Studio**
...
# **6. Cargar datos de 'propietary software' en R**
...
# **7. Lugares ricos en datos (Bases estructuradas)**
